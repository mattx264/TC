    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "system", new DateTime(2019, 11, 26, 10, 56, 57, 126, DateTimeKind.Local).AddTicks(3243), new DateTime(2019, 11, 26, 10, 56, 57, 136, DateTimeKind.Local).AddTicks(8594), "", true, "system", "Google" });

            migrationBuilder.InsertData(
                table: "ProjectDomain",
                columns: new[] { "Id", "CreatedBy", "DateAdded", "DateModified", "Domain", "IsActive", "ModifiedBy", "ProjectId" },
                values: new object[] { 1, "system", new DateTime(2019, 11, 26, 10, 56, 57, 140, DateTimeKind.Local).AddTicks(5335), new DateTime(2019, 11, 26, 10, 56, 57, 140, DateTimeKind.Local).AddTicks(6345), "google.com", true, "system", 1 });

            migrationBuilder.InsertData(
                table: "ProjectDomain",
                columns: new[] { "Id", "CreatedBy", "DateAdded", "DateModified", "Domain", "IsActive", "ModifiedBy", "ProjectId" },
                values: new object[] { 2, "system", new DateTime(2019, 11, 26, 10, 56, 57, 140, DateTimeKind.Local).AddTicks(7869), new DateTime(2019, 11, 26, 10, 56, 57, 140, DateTimeKind.Local).AddTicks(7928), "google.pl", true, "system", 1 });

            migrationBuilder.InsertData(
                table: "TestInfo",
                columns: new[] { "Id", "CreatedBy", "DateAdded", "DateModified", "Description", "IsActive", "ModifiedBy", "Name", "ProjectId", "SeleniumCommands" },
                values: new object[] { 1, "system", new DateTime(2019, 11, 26, 10, 56, 57, 141, DateTimeKind.Local).AddTicks(8098), new DateTime(2019, 11, 26, 10, 56, 57, 141, DateTimeKind.Local).AddTicks(9212), "Using google search find c# tutorial", true, "system", "Search for c# tutorial", 1, "[{\"OperationId\":3,\"WebDriverOperationType\":0,\"Values\":[\"https://www.google.com\"]}]" });
