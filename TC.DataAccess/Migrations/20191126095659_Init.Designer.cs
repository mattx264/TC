            ...
            modelBuilder.Entity("TC.Entity.Entities.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "system",
                            DateAdded = new DateTime(2019, 11, 26, 10, 56, 57, 126, DateTimeKind.Local).AddTicks(3243),
                            DateModified = new DateTime(2019, 11, 26, 10, 56, 57, 136, DateTimeKind.Local).AddTicks(8594),
                            Description = "",
                            IsActive = true,
                            ModifiedBy = "system",
                            Name = "Google"
            ...
            modelBuilder.Entity("TC.Entity.Entities.ProjectDomain", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "system",
                            DateAdded = new DateTime(2019, 11, 26, 10, 56, 57, 140, DateTimeKind.Local).AddTicks(5335),
                            DateModified = new DateTime(2019, 11, 26, 10, 56, 57, 140, DateTimeKind.Local).AddTicks(6345),
                            Domain = "google.com",
                            IsActive = true,
                            ModifiedBy = "system",
                            ProjectId = 1
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "system",
                            DateAdded = new DateTime(2019, 11, 26, 10, 56, 57, 140, DateTimeKind.Local).AddTicks(7869),
                            DateModified = new DateTime(2019, 11, 26, 10, 56, 57, 140, DateTimeKind.Local).AddTicks(7928),
                            Domain = "google.pl",
                            IsActive = true,
                            ModifiedBy = "system",
                            ProjectId = 1
            ...
            modelBuilder.Entity("TC.Entity.Entities.TestInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "system",
                            DateAdded = new DateTime(2019, 11, 26, 10, 56, 57, 141, DateTimeKind.Local).AddTicks(8098),
                            DateModified = new DateTime(2019, 11, 26, 10, 56, 57, 141, DateTimeKind.Local).AddTicks(9212),
