        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScreenshotId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "system", new DateTime(2020, 2, 7, 9, 20, 57, 874, DateTimeKind.Local).AddTicks(7455), new DateTime(2020, 2, 7, 9, 20, 57, 874, DateTimeKind.Local).AddTicks(8016), "false", "It will take a screenshot after every command.", true, "system", "Take Screenshot After Every Command", 0 },
                    { 2, "system", new DateTime(2020, 2, 7, 9, 20, 57, 874, DateTimeKind.Local).AddTicks(8931), new DateTime(2020, 2, 7, 9, 20, 57, 874, DateTimeKind.Local).AddTicks(8958), "false", "Test will monitor every http call.", true, "system", "Monitoring Http Calls", 0 },
                    { 3, "system", new DateTime(2020, 2, 7, 9, 20, 57, 874, DateTimeKind.Local).AddTicks(9015), new DateTime(2020, 2, 7, 9, 20, 57, 874, DateTimeKind.Local).AddTicks(9022), "true", "Test will continue even if a command will fail.", true, "system", "Continue After Command Failure", 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "system", new DateTime(2020, 2, 7, 9, 20, 57, 868, DateTimeKind.Local).AddTicks(1660), new DateTime(2020, 2, 7, 9, 20, 57, 870, DateTimeKind.Local).AddTicks(8486), true, "system", "Pending" },
                    { 2, "system", new DateTime(2020, 2, 7, 9, 20, 57, 870, DateTimeKind.Local).AddTicks(9261), new DateTime(2020, 2, 7, 9, 20, 57, 870, DateTimeKind.Local).AddTicks(9290), true, "system", "Accepted" },
                    { 3, "system", new DateTime(2020, 2, 7, 9, 20, 57, 870, DateTimeKind.Local).AddTicks(9305), new DateTime(2020, 2, 7, 9, 20, 57, 870, DateTimeKind.Local).AddTicks(9309), true, "system", "Rejected" },
                    { 4, "system", new DateTime(2020, 2, 7, 9, 20, 57, 870, DateTimeKind.Local).AddTicks(9313), new DateTime(2020, 2, 7, 9, 20, 57, 870, DateTimeKind.Local).AddTicks(9317), true, "system", "Deleted" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "system", new DateTime(2020, 2, 7, 9, 20, 57, 872, DateTimeKind.Local).AddTicks(8278), new DateTime(2020, 2, 7, 9, 20, 57, 872, DateTimeKind.Local).AddTicks(8887), "", true, "system", "Google" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "system", new DateTime(2020, 2, 7, 9, 20, 57, 873, DateTimeKind.Local).AddTicks(3309), new DateTime(2020, 2, 7, 9, 20, 57, 873, DateTimeKind.Local).AddTicks(3884), "google.com", true, "system", 1 },
                    { 2, "system", new DateTime(2020, 2, 7, 9, 20, 57, 873, DateTimeKind.Local).AddTicks(4743), new DateTime(2020, 2, 7, 9, 20, 57, 873, DateTimeKind.Local).AddTicks(4773), "google.pl", true, "system", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "system", new DateTime(2020, 2, 7, 9, 20, 57, 875, DateTimeKind.Local).AddTicks(3151), new DateTime(2020, 2, 7, 9, 20, 57, 875, DateTimeKind.Local).AddTicks(3697), true, "system", 1, "true" });

            migrationBuilder.InsertData(
                schema: "test",
                table: "TestInfo",
                columns: new[] { "Id", "CreatedBy", "DateAdded", "DateModified", "Description", "IsActive", "ModifiedBy", "Name", "ProjectId", "SeleniumCommands" },
                values: new object[] { 1, "system", new DateTime(2020, 2, 7, 9, 20, 57, 874, DateTimeKind.Local).AddTicks(1593), new DateTime(2020, 2, 7, 9, 20, 57, 874, DateTimeKind.Local).AddTicks(2160), "Using google search find c# tutorial", true, "system", "Search for c# tutorial", 1, "[{\"OperationId\":3,\"WebDriverOperationType\":0,\"Values\":[\"https://www.google.com\"]}]" });
